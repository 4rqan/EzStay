...
route.post("/paymentaccount", requireAuth, async (req, res) => {
  ...
  try {
    ...
    res.status(400).send("Inavlid Keys");
  }
});

route.get("/paymentAccount", requireAuth, async (req, res) => {
...
route.get("/getPaymentAccount/:profileId", async (req, res) => {
